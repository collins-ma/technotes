      ...
      <div className="max-w-4xl w-full space-y-8 bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="mt-4">
                ...
                {filteredUsers.map(user => (
                  <tr key={user._id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap flex items-center space-x-4">
                      <Link to={`/manager/edit-user/${user._id}`} className="text-indigo-600 hover:text-indigo-900">
          ...
          <div className="text-center">
            <Link to="/manager-dashboard" className="mt-4 block text-sm font-medium text-indigo-600 hover:text-indigo-500">
